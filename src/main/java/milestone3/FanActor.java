...
/**
 * A class of the fan Actor. 
 * @author Sven Andresen
 *
 */
public class FanActor extends Ressource<Long> implements ArduinoListener {
    ...
    static{
        ...
        payloadTemplates.put(
	        ...
	        "itm:ourPi pit:hasComponent itm:fan .\n" +
	        "itm:tempSensor rds:type pit:Component .\n" +
	        "itm:tempSensor pit:isType \"FAN\"^^xsd:string .\n" +
	        "itm:tempSensor pit:isActor \"true\"^^xsd:boolean .\n" +
	        "itm:tempSensor pit:hasDescription \"Fan with the speed given in RPM\"^^xsd:string .\n" +
	        "itm:tempSensor pit:hasURL \"coap://141.83.175.252:5683/fan\"^^xsd:anyURI .\n" +
	        "itm:tempSensor pit:hasStatus itm:fanSensorState .\n" +
	        "itm:tempSensorState pit:hasValue \"%d\"^^xsd:string .\n" +
	        "itm:tempSensor pit:lastModified \"%s\"^^xsd:dateTime .\n" +
	        "itm:tempSensorState pit:hasScaleUnit \"RPM\"^^xsd:string .\n"
        );        
    }
    ...
    private int lastReadFanValue = 0; //as default indicating none has been read yet
	...
	/**
	 * Create a Fan Ressource.
	 * @param path
	 * @param updateInterval
	 * @param executor
	 */
	public FanActor(String path, int updateInterval, ScheduledExecutorService executor) {
	...
	public byte[] getSerializedResourceStatus(long contentFormat) {
        ...
        if (template == null) {
            ...
            return String.format(template, lastReadFanValue, fmt.format(new Date())).getBytes(CoapMessage.CHARSET);
        }
	}
	...
	@Override
	public void processCoapRequest(SettableFuture responseFuture, CoapRequest coapRequest,
